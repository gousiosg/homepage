...
function copy_files() {
  cp "$1/index.html" "$2"
  find "$1/lectures" "$1/assignments" "$1/notebooks" -type f -name '*.html' -print0 | xargs -0 -I{} cp {} "$2"
  find "$1/lectures" "$1/assignments" "$1/notebooks" -type f -name '*.pdf' -print0 | xargs -0 -I{} cp {} "$2"
  find "$1/lectures" "$1/assignments" "$1/notebooks" -type f -name '*.ipynb' -print0 | grep -zv ".ipynb_check" | xargs -0 -I{} cp {} "$2"
}
